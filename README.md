...
## 1.0.6
 ...
 - 전투결과 보기 설정 추가 (미리보기, 전투 후 보기, 안 보기)
## 1.0.7
...
## 1.1.0
 ...
 - 임무 완료 자동 알림 추가 (출격, 연습, 원정을 지원하며 나머지는 새로고침시 100%인 경우 알림이 나옵니다.)
 - 전투정보 개선 (적 함 정보 출력)
 - 연습전시 전투 정보 제공
 - 우측 상단의 간단한 알림 추가
## 1.1.1
 - 전투 현황의 HP가 소숫점으로 나오는 현상 수정
 - 전투 현황의 탄약, 연료가 -가 되는 현상 수정
...
## 1.2.1
 ...
 - 함대 정보 상세 보기 페이지에 피로도, 경험치 정보 출력
## 1.2.2
 - 1-6 전투현황 에러 수정
 - DMM 레이아웃 변경에 따른 수정
## 1.2.3
